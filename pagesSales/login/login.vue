<template>
	<view class="pg">
		...
		<view class="wrap">
			...
			<view class="card">
				<view class="scope">
					<bl-icon name="lock" :size="28" color="#2C7256" :weight="1.9" />
